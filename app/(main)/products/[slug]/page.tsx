...
export default function ProductDetailPage() {
  ...
  if (product === undefined) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-white via-emerald-50 to-green-50">
  ...
  if (!product || product.status !== 'published') {
    return (
      <div className="min-h-screen bg-gradient-to-b from-white via-emerald-50 to-green-50 flex items-center justify-center">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-emerald-50 to-green-50">
      {/* Breadcrumb */}
      <div className="bg-white backdrop-blur-sm border-b border-emerald-200">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center gap-2 text-sm">
            ...
            <Link href={config.backLink} className="text-gray-600 hover:text-emerald-600 transition-colors">
              {config.label}
            </Link>
            <span className="text-gray-400">/</span>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 text-gray-700 hover:text-emerald-600 mb-8 group transition-colors"
            >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-4">
                {product.image ? (
                  <div className="relative aspect-square rounded-2xl overflow-hidden bg-white backdrop-blur-sm border-2 border-emerald-200 shadow-lg">
                    <Image
                      src={product.image}
                      alt={product.name}
                      fill
                  ...
                  <div className="relative aspect-square rounded-2xl overflow-hidden bg-white backdrop-blur-sm border-2 border-emerald-200 shadow-lg group">
                    <div className="absolute -inset-1 bg-gradient-to-r from-emerald-400/20 to-emerald-500/20 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                    <Image
                ...
                <Button
                  variant="outline"
                  className="w-full border-emerald-300 text-gray-700 hover:border-emerald-500 hover:text-emerald-600 bg-white"
                  onClick={handleShare}
                >
              ...
              <div className="space-y-6">
                ...
                {product.benefits && product.benefits.length > 0 && (
                  <Card className="border-2 border-emerald-200 bg-emerald-50 backdrop-blur-sm">
                ...
                {product.specifications && product.specifications.length > 0 && (
                  <Card className="border-2 border-emerald-200 bg-white backdrop-blur-sm">
                    <CardContent className="p-6">
                      <h3 className="text-lg font-semibold text-gray-900 mb-4">
                        Specifications
                      </h3>
                      <div className="space-y-3">
                        {product.specifications.map((spec, idx) => (
                          <div
                            key={idx}
                            className="flex justify-between items-center py-2 border-b border-emerald-200 last:border-0"
                          >
                ...
                <Button
                  size="lg"
                  className="w-full bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white py-6 text-lg shadow-lg shadow-emerald-500/25"
                  onClick={() => {
          ...
          <div className="max-w-6xl mx-auto mt-16 px-4">
            <div className="text-center mb-8">
              <div className="inline-flex items-center gap-2 mb-4">
                ...
                <h2 className="text-3xl font-bold text-gray-900">Official Certifications & Approvals</h2>
              </div>
      ...
      {/* Quote Form */}
      <section id="quote-form" className="py-20 bg-gradient-to-b from-white via-emerald-50 to-green-50 relative overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
